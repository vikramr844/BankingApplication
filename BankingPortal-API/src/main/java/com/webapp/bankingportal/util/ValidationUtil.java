...
//    }
    ...
    public static boolean isValidPhoneNumber(String countryCode) {
        if (countryCode == null || countryCode.trim().isEmpty()) {
            throw new UserInvalidException("Country code cannot be empty or null.");
        }
        return true;
    }
...
//        }
        ...
        if (!isValidPhoneNumber(user.getCountryCode())) {
